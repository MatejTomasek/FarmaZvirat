...
public class Farma {
    ...
    public static final int MAX_POCET_ZVIRAT = 1000;
        ...
        try {
            ...
            if (args.length > 0) {
                ...
                if (kapacita > MAX_POCET_ZVIRAT) {
                    System.out.println("Prekroceni maximalniho poctu zvirat farmy.");
                    System.exit(111);
                }
            }
            ...
            System.out.println("Chyba ve formatu cisla s meznim poctem zvirat.");
            System.exit(112);
        }
        catch (NullPointerException ex) {
            System.out.println("Chyba ve null.");
        }
    }
}
